...
public class Ex214MainActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_ex214_main);
    ...
    class viewFactory implements ViewSwitcher.ViewFactory
    {
        ...
        {
            ImageView imageView = new ImageView(Ex214MainActivity.this);
